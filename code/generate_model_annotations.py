                    ...
                    for _,row in pbar:
                        ...
                        for _,sz_row in qbar:
                            ...
                            for mdl_str in mdl_strs:
                                ...
                                if movdata=='prob':
                                    if movtype == 'mean':
                                        sz_prob = sc.ndimage.uniform_filter1d(sz_prob,size=movwin,mode='nearest',axes=1,origin=0)
                                    if movtype == 'median':
                                ...
                                for final_thresh in np.linspace(0,4,750):
                                    ...
                                    if movdata == 'clf':
                                        if movtype == 'mean':
                                            sz_clf_final = sc.ndimage.uniform_filter1d(sz_clf,size=movwin,mode='nearest',axes=1,origin=0)
                                        if movtype == 'median':
